...
class MainSettings:
    def get_seasonal_copyright():
        ...
        if (now.month == 10 and now.day >= 31) or (now.month == 11 and now.day <= 2):
            return f"Riverya4life © 2022-{now.year} | All rights reserved 🎃"
            ...
            return f"Riverya4life © 2022-{now.year} | All rights reserved ❄️"
    ...
    BOT_VERSION = "v1.6.2 (<t:1687898840:d>)"
...
class EconomySystem(commands.Cog):
    ...
    def get_seasonal_bonus_eco():
        ...
        if (now.month == 10 and now.day >= 31) or (now.month == 11 and now.day <= 2):
            ...
            return {"exp": 10, "balance": 0.50, "multiplier": 2.0, "commission": 4}
