...
class RankCard:
    ...
    __slots__ = ('background', 'rank', 'background_color', 'text_color', 'bar_color', 'settings', 'avatar', 'status', 'level', 'username', 'current_exp', 'max_exp')
    ...
    async def card(self, resize: int = 100)-> Union[None, bytes]:
        ...
        mask = Image.open(path + "/assets/mask_circle.png").resize((260, 260))
        ...
        myFont = ImageFont.truetype(path + "/assets/regular.ttf",50)
        ...
        draw.text((950-w,40), combined,font=myFont, fill=self.bar_color,stroke_width=1,stroke_fill=(0, 0, 0))
