...
class DataBase:
    def __init__(self):
        self.db_main = f"{os.path.realpath(os.path.dirname(__file__))}/../database/main_database.sql"
        self.db_shop = f"{os.path.realpath(os.path.dirname(__file__))}/../database/shop_database.sql"
        self.db_levelsys = f"{os.path.realpath(os.path.dirname(__file__))}/../database/level_database.sql"
        self.db_tempvoice = f"{os.path.realpath(os.path.dirname(__file__))}/../database/tempvoice_database.sql"
        self.db_warns = f"{os.path.realpath(os.path.dirname(__file__))}/../database/warns_database.sql"
        self.db_bot_stat = f"{os.path.realpath(os.path.dirname(__file__))}/../database/fistashkinbot.sql"
        self.db_logs = f"{os.path.realpath(os.path.dirname(__file__))}/../database/logs_database.sql"
    ...
    async def create_table(self):
        ...
        # Logs
        async with aiosqlite.connect(self.db_logs) as db:
            cursor = await db.cursor()
            query = """
