...
class CommandInfoBySlash(commands.Cog):
    ...
    @commands.slash_command(name = 'юзер', description = 'Показывает информацию об участнике.', dm_permission=False)
    ...
    @commands.slash_command(name = 'сервер', description = 'Показывает информацию о сервере.', dm_permission=False)
    @commands.cooldown(1, 5, commands.BucketType.user)
    ...
    @commands.slash_command(name = 'аватар', description = 'Показывает аватар упомянутого участника или участника, вызвавшего команду.', dm_permission=False)
    @commands.cooldown(1, 5, commands.BucketType.user)
    ...
    @commands.slash_command(name = 'роли', description = 'Показывает все роли сервера.', dm_permission=False)
    @commands.cooldown(1, 5, commands.BucketType.user)
    ...
    @commands.slash_command(name = 'инфо', description = 'Показывает интересную информацию о боте.')
    @commands.cooldown(1, 5, commands.BucketType.user)
